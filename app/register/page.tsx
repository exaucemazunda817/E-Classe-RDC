    ...
    <div className="min-h-screen flex flex-col">
      ...
      <div className="flex-1 flex items-center justify-center px-6 py-10">
        <div className="w-full max-w-sm">
          <h1 className="text-2xl font-bold text-brand-navy mb-1">Créer un compte</h1>
          <p className="text-gray-500 mb-6">Commence à apprendre dès aujourd'hui 🎓</p>
