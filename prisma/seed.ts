...
async function main() {
  ...
  const plans = [
    { name: "Gratuit", priceUSD: 0, durationDays: 365, description: "Accès aux formations gratuites uniquement." },
    { name: "PRO", priceUSD: 999, durationDays: 30, description: "Accès à toutes les formations abordables et certifiantes." },
    { name: "Expert", priceUSD: 2499, durationDays: 30, description: "Accès complet, y compris les formations expertes." },
  ];
